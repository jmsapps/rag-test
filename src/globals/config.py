...
class Config(TypedDict):
    ...
    AZURE_OPENAI_CHAT_DEPLOYMENT_MODEL: str
    AZURE_OPENAI_CHAT_DEPLOYMENT_VERSION: str
    AZURE_OPENAI_CHAT_DEPLOYMENT_URL: str
    AZURE_OPENAI_CHAT_DEPLOYMENT_KEY: str
...
config: Config = {
    ...
    "AZURE_OPENAI_CHAT_DEPLOYMENT_VERSION": os.getenv(
        "AZURE_OPENAI_CHAT_DEPLOYMENT_VERSION"
    ),
    "AZURE_OPENAI_CHAT_DEPLOYMENT_URL": os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT_URL"),
    "AZURE_OPENAI_CHAT_DEPLOYMENT_KEY": os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT_KEY"),
